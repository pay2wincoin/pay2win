...
#if defined(NDEBUG)
# error "Pay2Win cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pay2Win Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Pay2Win also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Pay2Win also requires low S in sigs

...
const QString BITCOIN_IPC_PREFIX("pay2win:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/pay2win-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/pay2win-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/pay2win-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click pay2win: links
...
//
// OSX-specific way of handling pay2win: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in pay2win: URIs

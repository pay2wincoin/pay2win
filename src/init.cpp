...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pay2wincoin/pay2win>";
    const std::string URL_WEBSITE = "<https://p2w.digital/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Pay2Win Developers", 2022)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Pay2Win useful. "

...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"pay2winaddress\"\n"
            "\nReveals the private key corresponding to 'pay2winaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"pay2winaddress\"   (string, required) The pay2win address for the private key\n"
            "\nResult:\n"
